class EducationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education.save
        format.html { redirect_to user_path(@current_user), notice: 'The Education for ' + @education.school_name + ' was added to your profile'}
  ...
  def update
    respond_to do |format|
      if @education.update(education_params)
        format.html { redirect_to user_path(@current_user), notice: 'Education was successfully updated.' }
  ...
  def destroy
    @education.destroy
    respond_to do |format|
      format.html { redirect_to user_path(@current_user), notice: 'Education was successfully destroyed.' }
